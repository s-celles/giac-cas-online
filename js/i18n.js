...
const LOCALES = {
  en: {
    ...
    addMath: '+ Math', addRaw: '+ GIAC raw', addText: '+ Text',
    ...
    cellMath: 'Math', cellRaw: 'GIAC', cellText: 'Text',
    placeholderRaw: 'GIAC syntax (e.g. factor(x^4-1))',
    ...
    modeVisual: 'Visual math input', modeRaw: 'Raw GIAC syntax',
    invalidJson: 'Invalid JSON file',
    welcomeTitle: '# Welcome to rnGIAC',
    welcomeBody: 'Type math visually (MathJSON) or use raw GIAC syntax.\nTick **Show MathJSON** at the bottom to inspect the conversion pipeline.\n\nText cells support LaTeX: inline $v = \\frac{d}{t}$ and display mode:\n\n$$\\vec{F} = m\\vec{a}$$',
  ...
  es: {
    ...
    welcomeBody: 'Escribe matemáticas visualmente (MathJSON) o usa sintaxis GIAC directa.\nMarca **Mostrar MathJSON** abajo para inspeccionar la conversión.\n\nLas celdas de texto soportan LaTeX: en línea $v = \\frac{d}{t}$ y en modo display:\n\n$$\\vec{F} = m\\vec{a}$$',
  ...
  ar: {
    ...
    welcomeBody: 'أدخل الرياضيات بصريًا (MathJSON) أو استخدم صيغة GIAC المباشرة.\nفعّل **إظهار MathJSON** في الأسفل لفحص عملية التحويل.\n\nتدعم خلايا النص LaTeX: مضمّن $v = \\frac{d}{t}$ ووضع العرض:\n\n$$\\vec{F} = m\\vec{a}$$',
  ...
  hi: {
    ...
    addMath: '+ गणित', addRaw: '+ GIAC कच्चा', addText: '+ पाठ',
  ...
  zh: {
    ...
    welcomeBody: '以可视化方式（MathJSON）或原始 GIAC 语法输入数学表达式。\n勾选底部的 **显示 MathJSON** 以查看转换过程。\n\n文本单元格支持 LaTeX：行内 $v = \\frac{d}{t}$ 和展示模式：\n\n$$\\vec{F} = m\\vec{a}$$',
