...
const LOCALES = {
  en: {
    ...
    example3dSurface: '3D Surface', example3dParametric: '3D Parametric Surface', example3dSliders: '3D Surface + Sliders',
  ...
  fr: {
    ...
    example3dSurface: 'Surface 3D', example3dParametric: 'Surface paramétrique 3D', example3dSliders: 'Surface 3D + Curseurs',
  ...
  es: {
    ...
    example3dSurface: 'Superficie 3D', example3dParametric: 'Superficie paramétrica 3D', example3dSliders: 'Superficie 3D + Deslizadores',
  ...
  de: {
    ...
    example3dSurface: '3D-Oberfläche', example3dParametric: 'Parametrische 3D-Oberfläche', example3dSliders: '3D-Oberfläche + Schieberegler',
  ...
  ar: {
    ...
    example3dSurface: 'سطح ثلاثي الأبعاد', example3dParametric: 'سطح بارامتري ثلاثي الأبعاد', example3dSliders: 'سطح ثلاثي الأبعاد + منزلقات',
  ...
  hi: {
    ...
    example3dSurface: '3D सतह', example3dParametric: '3D पैरामीट्रिक सतह', example3dSliders: '3D सतह + स्लाइडर',
  ...
  ru: {
    ...
    example3dSurface: '3D поверхность', example3dParametric: 'Параметрическая 3D поверхность', example3dSliders: '3D поверхность + ползунки',
  ...
  zh: {
    ...
    example3dSurface: '3D 曲面', example3dParametric: '3D 参数曲面', example3dSliders: '3D 曲面 + 滑块',
  ...
  ja: {
    ...
    example3dSurface: '3D 曲面', example3dParametric: '3D パラメトリック曲面', example3dSliders: '3D 曲面 + スライダー',
